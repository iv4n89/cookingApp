...
los archivos de `apps/mobile`. Los paquetes se validarán con las reglas base de
JavaScript/TypeScript disponibles en ESLint, sin acoplarlos al entorno React Native.
...
`typecheck` coordinará `tsc --noEmit` para los proyectos TypeScript existentes.
