-- household_today_decision v5: baraja las candidatas DENTRO de cada nivel de faltantes para dar
-- variedad en cada carga/refresco (mismo contrato del DTO). La destacada sigue respetando lo
-- crítico y el orden sigue siendo "menos faltantes primero"; solo se aleatoriza entre iguales.
-- La función pasa a volatile (usa random): es de pintado, no de auditoría.
...
begin
  ...
  -- Discover: una por tipo de cocina (aleatoria dentro de cada cocina), 5 al azar, sin las de pantry.
