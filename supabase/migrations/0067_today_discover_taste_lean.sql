-- household_today_decision v6: descubrimiento con lean por gusto. El bloque discover ordena por
-- azar ponderado con tasteAffinity (0.5 afinidad + 0.5 random) tanto dentro de cada cocina como
-- al elegir las 5 finales; tira hacia el estilo del hogar sin perder variedad. Cold start (sin
-- semillas, afinidad 0) = azar puro, igual que antes. Pantry (destacada + alternativas) no cambia.
